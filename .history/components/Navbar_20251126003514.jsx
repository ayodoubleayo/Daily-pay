...
export default function Navbar({ onMenuToggle }) {
  ...
  const [isShrunk, setIsShrunk] = useState(false);       // ⭐ navbar shrink
  const [isLoading, setIsLoading] = useState(false);     // ⭐ loading clicks
        ...
        >
          ...
          <form
            onSubmit={(e) => {
              ...
              if (q.length > 0) window.location.href = `/search?q=${q}`;
              closeMenu();
            }}
          ...
          >
            ...
            />
            <button type="submit" className="text-blue-700 font-semibold">🔍</button>
          </form>
